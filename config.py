...
SUPPORT_GRP = getenv("SUPPORT_GRP", "BWF_MUSIC1")
UPDATE_CHNL = getenv("UPDATE_CHNL", "SHAYRI_CHANNEL1")
OWNER_USERNAME = getenv("OWNER_USERNAME", "L2R_KING0")
...
# Random Stickers
STICKER = [
    "CAACAgUAAx0Cfd2c3gACF35lqLpCb1KPJgSiUsxm5BhuhNkfPwACnAwAAjD2AVXnFtUnUUBBJTQE",
    "CAACAgUAAx0Cfd2c3gACF4BlqLpIBhvHnM7P3V9KTsZBDzy_xQAC7QoAAjDDSVUtEXE-9xC_-zQE",
    "CAACAgUAAx0Cfd2c3gACF4RlqLqFNb28_pwPrl69fgbzXVjg-QACagsAAg6iSFUyrIuTIfC0HzQE",
]
